...
handler403 = 'cms.error_views.custom_permission_denied'
handler404 = 'cms.error_views.custom_page_not_found'
handler500 = 'cms.error_views.custom_server_error'
...
urlpatterns = [
    ...
    path('p/<str:token>/', medcare_views.patient_portal_view, name='patient_short_portal'),
]
